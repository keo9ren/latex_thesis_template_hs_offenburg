...
## Makefile originally taken from Karl Voit (Karl@Voit.net)
...
.PHONY: logo
logo:  
	epstopdf ${DIR_LOGO}ei-fb_cmyk-schrift_neuerfarbraum.eps --outfile=${DIR_LOGO}hs_og_ei.pdf	
	epstopdf ${DIR_LOGO}HS-Logo_BLAU.eps --outfile=${DIR_LOGO}hs_offenburg.pdf	
